...
class EditBurgerForm extends React.Component {
    ...
    handleChange  = event => {
        const updatedBurger = {
            ...this.props.burger,
            [event.currentTarget.name]: event.currentTarget.name === 'price' ? parseFloat(event.currentTarget.value) || 0 :
                event.currentTarget.value
        };

        this.props.updateBurgers(this.props.index, updatedBurger);
    }
    render() {
        return (
            ...
            <div className='burger-edit'>
                ...
                <button onClick={() => this.props.deleteBurger(this.props.index)}>Видалити бургер</button>
